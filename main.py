...
if __name__ == '__main__':
    ...
    parser.add_argument('--dl_tr', default=[256, 4, 2, True], nargs=4, 
    ...
    parser.add_argument('--dl_u', default=[3096, 4, 2, True], nargs=4, 
                        type=lambda vals: utils.parse_mixed(vals, [int, int, int, bool]),
    ...
    parser.add_argument('--dl_te', default=[3096, 4, 2, True], nargs=4, 
                        type=lambda vals: utils.parse_mixed(vals, [int, int, int, bool]),
