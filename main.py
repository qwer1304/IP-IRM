...
if __name__ == '__main__':
    ...
    feature_dim, temperature, moco_temperature, k = args.feature_dim, args.temperature, args.moco_temperature, args.k
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            if not args.baseline and args.evaluate is None:
